...
__export(src_exports, {
  ...
  $fontSize: () => font_size_vars_exports,
  $fontWeight: () => font_weight_vars_exports,
  $horizontalSpacing: () => horizontal_spacing_vars_exports,
  $lineHeight: () => line_height_vars_exports,
  $radius: () => radius_vars_exports,
  $unit: () => unit_vars_exports
});
