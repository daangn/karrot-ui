...
:root[data-seed]:not([data-seed="dark-only"]) [data-seed-scale-color="light"] {
  ...
  --seed-color-palette-static-black-alpha-200: #00000033;
  --seed-color-palette-static-black-alpha-500: #00000080;
  --seed-color-palette-static-white-alpha-200: #ffffff33;
  --seed-color-palette-static-white-alpha-800: #ffffffcc;
  ...
  --seed-color-fg-brand-contrast: var(--seed-color-palette-carrot-800);
...
:root[data-seed]:not([data-seed="light-only"]) [data-seed-scale-color="dark"] {
  ...
  --seed-color-palette-gray-00: #121212;
  --seed-color-palette-gray-100: #1a1c20;
  --seed-color-palette-gray-200: #25272c;
  --seed-color-palette-gray-300: #2c2e34;
  --seed-color-palette-gray-400: #3e4145;
  ...
  --seed-color-fg-magic: var(--seed-color-palette-purple-700);
  --seed-color-fg-brand-contrast: var(--seed-color-palette-carrot-900);
  --seed-color-fg-critical-contrast: var(--seed-color-palette-red-900);
  --seed-color-fg-informative-contrast: var(--seed-color-palette-blue-900);
  --seed-color-fg-magic-contrast: var(--seed-color-palette-purple-900);
  --seed-color-fg-neutral-muted: var(--seed-color-palette-gray-800);
  ...
  --seed-color-bg-overlay: var(--seed-color-palette-static-black-alpha-500);
  --seed-color-bg-disabled: var(--seed-color-palette-gray-200);
  --seed-color-bg-brand-weak: var(--seed-color-palette-carrot-200);
  ...
  --seed-color-bg-brand-weak-pressed: var(--seed-color-palette-carrot-300);
  --seed-color-bg-critical-weak: var(--seed-color-palette-red-100);
  ...
  --seed-color-bg-layer-default: var(--seed-color-palette-gray-00);
  --seed-color-bg-layer-fill: var(--seed-color-palette-gray-100);
  --seed-color-bg-layer-basement: var(--seed-color-palette-gray-100);
  --seed-color-bg-layer-floating: var(--seed-color-palette-gray-100);
  --seed-color-bg-layer-default-pressed: var(--seed-color-palette-gray-200);
