...
export const magicSolid = "var(--seed-color-bg-magic-solid)";
export const magicWeak = "var(--seed-color-bg-magic-weak)";
export const magicSolidPressed = "var(--seed-color-bg-magic-solid-pressed)";
export const magicWeakPressed = "var(--seed-color-bg-magic-weak-pressed)";
