import type { SerializedPaintStyle, SerializedTextStyle } from "@/features/design-system/types";
import { getAllTextNodesInSceneNodes } from "@/features/design-system/utils/nodes";
