import * as oldComponents from "@/features/design-system/data/__generated__/v2-component-sets";
import * as newComponents from "@/features/design-system/data/__generated__/v3-component-sets";
import type { InstanceInfo } from "@/features/design-system/types";
import { getTopmostComponent } from "@/features/design-system/utils/nodes";
...
export const getComponentInSceneNodes = async ({ nodeIds }: GetComponentInSceneNodesOptions) => {
