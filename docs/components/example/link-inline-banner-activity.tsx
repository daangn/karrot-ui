...
import { LinkInlineBanner, type LinkInlineBannerProps } from "seed-design/ui/link-inline-banner";
...
declare module "@stackflow/config" {
  interface Register {
    LinkInlineBanner: unknown;
  }
}

const LinkInlineBannerActivity: ActivityComponentType<"LinkInlineBanner"> = () => {
  const [variant, setVariant] =
    React.useState<Extract<LinkInlineBannerProps["variant"], "neutralWeak" | "dangerSolid">>(
      "dangerSolid",
    );
...
export default LinkInlineBannerActivity;
