...
import { V2, V3 } from "@/components/mdx/icon";
...
- [`@daangn/react-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/react-monochrome-icon)
  ...
  - codemod 실행 시, 기존 아이콘은 모두 이 패키지의 아이콘으로 대체돼요.
...
| ----------------------------------- | ------------------------------------------------------------------------- |
| <V2 name="IconBoldThin" />          | <V3 type="monochrome" name="IconTUppercaseSerifLine" />                   |
| <V2 name="IconBoldRegular" />       | <V3 type="monochrome" name="IconTUppercaseSerifLine" />                   |
| <V2 name="IconBoldFill" />          | <V3 type="monochrome" name="IconTUppercaseSerifFill" />                   |
| <V2 name="IconCobuyingThin" />      | <V3 type="monochrome" name="IconShoppingbag2StackedLine" />               |
| <V2 name="IconCobuyingRegular" />   | <V3 type="monochrome" name="IconShoppingbag2StackedLine" />               |
| <V2 name="IconCobuyingFill" />      | <V3 type="monochrome" name="IconShoppingbag2StackedFill" />               |
| <V2 name="IconDeliveryThin" />      | <V3 type="monochrome" name="IconTruckLine" />                             |
| <V2 name="IconDeliveryRegular" />   | <V3 type="monochrome" name="IconTruckLine" />                             |
| <V2 name="IconDeliveryFill" />      | <V3 type="monochrome" name="IconTruckFill" />                             |
| <V2 name="IconSuggestThin" />       | <V3 type="monochrome" name="IconLightbulbDot5Line" />                     |
| <V2 name="IconSuggestRegular" />    | <V3 type="monochrome" name="IconLightbulbDot5Line" />                     |
| <V2 name="IconSuggestFill" />       | <V3 type="monochrome" name="IconLightbulbDot5Fill" />                     |
| <V2 name="IconWriteStoryThin" />    | <V3 type="monochrome" name="IconHorizline2VerticalChatbubbleRightLine" /> |
| <V2 name="IconWriteStoryRegular" /> | <V3 type="monochrome" name="IconHorizline2VerticalChatbubbleRightLine" /> |
| <V2 name="IconWriteStoryFill" />    | <V3 type="monochrome" name="IconHorizline2VerticalChatbubbleRightFill" /> |
