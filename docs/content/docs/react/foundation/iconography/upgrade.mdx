...
- [`@karrotmarket/karrot-ui-icon`](https://www.npmjs.com/package/@karrotmarket/karrot-ui-icon)에서 제공되는 React 컴포넌트를 사용하는 경우 (deprecated)
...
- PNG, SVG 등의 파일로 기존 아이콘을 사용하는 경우
  - [`@karrotmarket/karrot-ui-icon`](https://www.npmjs.com/package/@karrotmarket/karrot-ui-icon)에서 제공되는 SVG 파일을 사용하는 경우 (deprecated)
- Vue 아이콘 패키지를 사용하는 경우
...
[`@daangn/react-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/react-monochrome-icon)과 [`@daangn/react-multicolor-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/react-multicolor-icon)을 설치해요.
...
- [`@seed-design/icon`](https://www.npmjs.com/package/@seed-design/icon)
- [`@seed-design/react-icon`](https://www.npmjs.com/package/@seed-design/react-icon)
- [`@seed-design/vue2-icon`](https://www.npmjs.com/package/@seed-design/vue2-icon)
- [`@seed-design/vue3-icon`](https://www.npmjs.com/package/@seed-design/vue3-icon)

```package-install
npm uninstall @karrotmarket/karrot-ui-icon @seed-design/icon @seed-design/react-icon @seed-design/vue2-icon @seed-design/vue3-icon
```
...
- 따라서, 멀티컬러 사용이 적절한지 확인이 필요해요. 단색 아이콘(`@daangn/react-monochrome-icon`)이 쓰여야 하는 곳이라면 수정해야 해요.
...
- 한 이전 아이콘의 3개 variant 중 `thin` variant와 `regular` variant는 리뉴얼된 아이콘에서 모두 `line` variant로 대체돼요.
  - 예를 들면, `IconForwardThin`, `IconForwardRegular`는 모두 [`IconArrowRightLine`](/docs/design/foundation/iconography?icon=icon_arrow_right_line)으로 대체돼요.
...
- 완전히 다른 이전 아이콘이 하나의 리뉴얼된 아이콘으로 대체되는 경우도 있어요.
  - 예를 들면, `IconHeadphoneRegular`, `IconHelpcenterRegular`, `IconHelperRegular`는 모두 [`IconHeadsetLine`](/docs/design/foundation/iconography?icon=icon_headset_line)으로 대체돼요.
