...
두 패키지에서 사용하고 있는 아이콘에 따라 [`@daangn/react-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/react-monochrome-icon)과 [`@daangn/react-multicolor-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/react-multicolor-icon)으로 대체돼요.
...
- 다음 패키지를 사용하는 경우
  ...
  - 두 패키지는 각각 다음 패키지로 대체돼요.
    - [`@daangn/vue2-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue2-monochrome-icon)과 [`@daangn/vue2-multicolor-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue2-multicolor-icon)
    - [`@daangn/vue3-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue3-monochrome-icon)과 [`@daangn/vue3-multicolor-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue3-multicolor-icon)
