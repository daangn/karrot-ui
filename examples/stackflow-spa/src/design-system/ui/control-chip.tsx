...
export interface ToggleControlChipProps extends SeedControlChip.RootBaseProps, Checkbox.RootProps {
...
export const ButtonControlChip = React.forwardRef<HTMLButtonElement, ButtonControlChipProps>(
  ({ children, prefixIcon, suffixIcon, layout = "withText", ...otherProps }, ref) => {
    return (
